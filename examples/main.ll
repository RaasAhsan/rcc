...
define i32 @main() #0 {
  ...
  %4 = bitcast %struct.example* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %4, i8* align 4 bitcast (%struct.example* @__const.main.s to i8*), i64 8, i1 false)
